...
export const getServerSideProps: GetServerSideProps<Props> = async () => {
  ...
  await Promise.all(
    query_option_list.map((query_option) => {
      return query_client.prefetchQuery(query_option);
    })
  );
...
const Home: FC<Props> = (props) => {
  return <HydrationBoundary state={props.dehydrated_state}><HomeMain /></HydrationBoundary>;
};
